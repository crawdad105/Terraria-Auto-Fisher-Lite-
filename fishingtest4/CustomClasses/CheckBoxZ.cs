...
{
    class CheckBoxZ : System.Windows.Forms.CheckBox
    {
        Color clr1, clr2;
        ...
        private int textY = 4;
        private String text = ""; public String DisplayText
        {
            get { return text; }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //drawing check box
            Text
            ControlPaint.DrawButton(e.Graphics, rc, this.Checked ? ButtonState.Checked : ButtonState.Normal);
            b.Dispose();
        }
    }
}